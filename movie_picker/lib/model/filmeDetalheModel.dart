...
//
//     final filmeDetalhesModel = filmeDetalhesModelFromMap(jsonString);

import 'dart:convert';

FilmeDetalhesModel filmeDetalhesModelFromMap(String str) => FilmeDetalhesModel.fromMap(json.decode(str));

String filmeDetalhesModelToMap(FilmeDetalhesModel data) => json.encode(data.toMap());

class FilmeDetalhesModel {
    bool adult;
    String backdropPath;
    ...
    factory FilmeDetalhesModel.fromMap(Map<String, dynamic> json) => FilmeDetalhesModel(
        adult: json["adult"],
